      ...
      <div className="section">
        ...
        <div className="grid-one grid">
          ...
          <div>
            ...
            <p>{data?.appData.lastLogin.slice(0, 10)}</p>
          </div>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="grid-one grid">
          <div>
            ...
            <p>{data?.systemData.createdAt.slice(0, 10)}</p>
          </div>{" "}
          <div>
            <span>updated at</span>
            <p>{data?.systemData.updatedAt.slice(0, 10)}</p>
          </div>
          <div>
            <span>last activity</span>
            <p>{data?.systemData.lastActivity.slice(0, 10)}</p>
          </div>
        </div>
      </div>
    </div>
